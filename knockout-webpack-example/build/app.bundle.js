  ...
  (function (n) {
    var x = this || (0, eval)("this"),
       ...
       true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__], __WEBPACK_AMD_DEFINE_FACTORY__ = (n),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" === typeof exports && "object" === typeof module ? n(module.exports || exports) : n(x.ko = {});
    })(function (N, O) {
      function J(a, c) {
        ...
        function b(a, b) {
          ...
          for (var a = 3, b = t.createElement("div"), c = b.getElementsByTagName("i"); b.innerHTML = "\x3c!--[if gt IE " + ++a + "]><i></i><![endif]--\x3e", c[0];);return 4 < a ? a : n;
            ...
            r = /\S+/g;return { gc: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/], r: function (a, b) {
            for (var c = 0, d = a.length; c < d; c++) b(a[c], c);
          }, o: function (a, b) {
            if ("function" == typeof Array.prototype.indexOf) return Array.prototype.indexOf.call(a, b);for (var c = 0, d = a.length; c < d; c++) if (a[c] === b) return c;return -1;
          }, Vb: function (a, b, c) {
            for (var d = 0, e = a.length; d < e; d++) if (b.call(c, a[d], d)) return a[d];return null;
          }, Na: function (b, c) {
            var d = a.a.o(b, c);0 < d ? b.splice(d, 1) : 0 === d && b.shift();
          }, Wb: function (b) {
            b = b || [];for (var c = [], d = 0, e = b.length; d < e; d++) 0 > a.a.o(c, b[d]) && c.push(b[d]);return c;
          }, ib: function (a, b) {
            a = a || [];for (var c = [], d = 0, e = a.length; d < e; d++) c.push(b(a[d], d));return c;
          }, Ma: function (a, b) {
            a = a || [];for (var c = [], d = 0, e = a.length; d < e; d++) b(a[d], d) && c.push(a[d]);return c;
          }, ta: function (a, b) {
            ...
            b = a.a.W(b);for (var c = (b[0] && b[0].ownerDocument || t).createElement("div"), d = 0, e = b.length; d < e; d++) c.appendChild(a.ba(b[d]));return c;
          }, wa: function (b, c) {
            for (var d = 0, e = b.length, m = []; d < e; d++) {
              var k = b[d].cloneNode(!0);m.push(c ? a.ba(k) : k);
            }return m;
          }, fa: function (b, c) {
            a.a.rb(b);if (c) for (var d = 0, e = c.length; d < e; d++) b.appendChild(c[d]);
          }, uc: function (b, c) {
            var d = b.nodeType ? [b] : b;if (0 < d.length) {
              for (var e = d[0], m = e.parentNode, k = 0, f = c.length; k < f; k++) m.insertBefore(c[k], e);k = 0;for (f = d.length; k < f; k++) a.removeNode(d[k]);
            }
          }, Ba: function (a, b) {
            if (a.length) {
            ...
            if (a === b) return !0;if (11 === a.nodeType) return !1;if (b.contains) return b.contains(3 === a.nodeType ? a.parentNode : a);if (b.compareDocumentPosition) return 16 == (b.compareDocumentPosition(a) & 16);for (; a && a != b;) a = a.parentNode;return !!a;
          }, qb: function (b) {
            ...
            var k;c && ("object" === typeof b.classList ? (k = b.classList[d ? "add" : "remove"], a.a.r(c.match(r), function (a) {
          ...
          yd: 7 === k, C: k, ic: function (b, c) {
            ...
            }, k = [], m = d.length - 1; 0 <= m; m--) e(d[m]) && k.push(d[m]);return k;
          }, kd: function (b) {
        ...
        function b(b, c) {
          ...
          var e = b(d, !1);if (e) for (var e = e.slice(0), l = 0; l < e.length; l++) e[l](d);a.a.e.clear(d);a.a.G.cleanExternalData(d);if (f[d.nodeType]) for (e = d.firstChild; d = e;) e = d.nextSibling, 8 === d.nodeType && c(d);
            ...
            e = { 1: !0, 8: !0, 9: !0 },
            f = { 1: !0, 9: !0 };return { qa: function (a, c) {
            ...
            if (e[b.nodeType] && (c(b), f[b.nodeType])) {
              var d = [];a.a.ta(d, b.getElementsByTagName("*"));for (var l = 0, m = d.length; l < m; l++) c(d[l]);
            }return b;
      ...
      a.ba = a.a.G.ba;a.removeNode = a.a.G.removeNode;a.b("cleanNode", a.ba);a.b("removeNode", a.removeNode);a.b("utils.domNodeDisposal", a.a.G);a.b("utils.domNodeDisposal.addDisposeCallback", a.a.G.qa);a.b("utils.domNodeDisposal.removeDisposeCallback", a.a.G.tc);(function () {
          ...
          var e;if (u) {
            if (u.parseHTML) e = u.parseHTML(c, d) || [];else {
              if ((e = u.clean([c], d)) && e[0]) {
                for (var k = e[0]; k.parentNode && 11 !== k.parentNode.nodeType;) k = k.parentNode;k.parentNode && k.parentNode.removeChild(k);
              }
            }
          } else {
            (e = d) || (e = t);var k = e.parentWindow || e.defaultView || x,
                ...
                p;p = (r = r.match(/^<([a-z]+)[ >]/)) && f[r[1]] || b;r = p[0];p = "ignored<div>" + p[1] + c + p[2] + "</div>";"function" == typeof k.innerShiv ? q.appendChild(k.innerShiv(p)) : (g && e.appendChild(q), q.innerHTML = p, g && q.parentNode.removeChild(q));for (; r--;) q = q.lastChild;e = a.a.W(q.lastChild.childNodes);
          }return e;
        };a.a.Eb = function (b, c) {
          a.a.rb(b);c = a.a.c(c);if (null !== c && c !== n) if ("string" != typeof c && (c = c.toString()), u) u(b).html(c);else for (var d = a.a.na(c, b.ownerDocument), e = 0; e < d.length; e++) b.appendChild(d[e]);
        };
      ...
      }();a.b("tasks", a.Z);a.b("tasks.schedule", a.Z.Za);a.b("tasks.runEarly", a.Z.rd);a.Aa = { throttle: function (b, c) {
        ...
        a.a.ab(this, D);D.ub(this);
          ...
          c = c || E;c === E && this.Kb();if (this.Ra(c)) {
            var d = c === E && this.Fc || this.F[c].slice(0);try {
              a.l.Xb();for (var e = 0, f; f = d[e]; ++e) f.T || f.jb(b);
            } finally {
              a.l.end();
            }
          }
        ...
        function b(a) {
          ...
          e = d.pop();
            ...
            e,
            f = 0;return { Xb: b, end: c, sc: function (b) {
            if (e) {
        ...
        b = b || [];if ("object" != typeof b || !("length" in b)) throw Error("The argument passed when initializing an observable array must be an array, or null, or undefined.");b = a.O(b);a.a.ab(b, a.ma.fn);return b.extend({ trackArrayChanges: !0 });
      };
      a.ma.fn = { remove: function (b) {
          ...
          var e = !1,
            ...
            function k(a, b, c) {
              ...
              var m = [],
                  ...
                  G = l;case "unshift":
                  for (c = 0; c < g; c++) k("added", d[c], G + c);break;case "pop":
                  G = l - 1;case "shift":
                  l && k("deleted", b[G], G);break;case "splice":
                  c = Math.min(Math.max(0, 0 > d[0] ? l + d[0] : d[0]), l);for (var l = 1 === g ? l : Math.min(c + (d[1] || 0), l), g = c + g - 2, G = Math.max(l, g), n = [], s = [], w = 2; c < G; ++c, ++w) c < l && s.push(k("deleted", b[c], c)), c < g && n.push(k("added", d[w], c));a.a.hc(s, n);break;default:
                  return;}f = m;
            }
          };
        }
        ...
        function e() {
          ...
          var a,
              c,
              d = this[s].s;for (a in d) if (d.hasOwnProperty(a) && (c = d[a], this.oa && c.$.Ha || c.$.Zc(c.pa))) return !0;
        }, gd: function () {
          ...
          if (a.gb && !this[s].i) {
            var c = a.Y(this.gd, this, "dirty"),
                d = a.Y(this.qd, this);return { $: a, k: function () {
                c.k();d.k();
              } };
        ...
        function b(a, f, g) {
          ...
          if (0 == arguments.length) throw Error("When calling ko.toJS, pass the object you want to convert.");return b(c, function (b) {
            for (var c = 0; a.I(b) && 10 > c; c++) b = b();return b;
          });
        ...
        a.j = { u: function (b) {
            ...
            switch (a.a.A(b)) {case "option":
                ...
                if ("" === c || null === c) c = n;for (var e = -1, f = 0, g = b.options.length, h; f < g; ++f) if (h = a.j.u(b.options[f]), h == c || "" == h && c === n) {
                  e = f;break;
        ...
        function b(b) {
          b = a.a.cb(b);123 === b.charCodeAt(0) && (b = b.slice(1, -1));var c = [],
            ...
            h = {};return { va: [], ga: h, Ab: b, Xa: function (e, m) {
            function k(b, e) {
              var m;if (!A) {
        ...
        function b(a) {
          ...
          var c = d(a, b);return c ? 0 < c.length ? c[c.length - 1].nextSibling : a.nextSibling : null;
            ...
            l = { ul: !0, ol: !0 };a.f = { aa: {}, childNodes: function (a) {
            return b(a) ? d(a) : a.childNodes;
          }, za: function (c) {
            if (b(c)) {
              c = a.f.childNodes(c);for (var d = 0, e = c.length; d < e; d++) a.removeNode(c[d]);
            } else a.a.rb(c);
          }, fa: function (c, d) {
            if (b(c)) {
              a.f.za(c);for (var e = c.nextSibling, f = 0, l = d.length; f < l; f++) e.parentNode.insertBefore(d[f], e);
            } else a.a.fa(c, d);
          }, qc: function (a, c) {
        ...
        function b(a) {
          ...
          var e,
            ...
            for (; e = k;) k = a.f.nextSibling(e), m.call(f, e);k = a.f.firstChild(c);
        ...
        function b(b, e) {
          var f = b.getAttribute("params");if (f) {
            var f = c.parseBindingsString(f, e, b, { valueAccessors: !0, bindingParams: !0 }),
              ...
              var e = c.p();return c.ca() ? a.m({ read: function () {
                  return a.a.c(c());
          ...
          return function () {
            var c = b(),
                f = a.g.Ec,
                g;for (g in f) f.hasOwnProperty(g) && c.createElement(g);return c;
          };
        ...
        }var e = 0;a.d.component = { init: function (f, g, h, l, m) {
            function k() {
      ...
      })();var Q = { "class": "className", "for": "htmlFor" };a.d.attr = { update: function (b, c) {
        ...
        a.d.checked = { after: ["value", "attr"], init: function (b, c, d) {
          ...
          } };a.h.ga.checked = !0;a.d.checkedValue = { update: function (b, c) {
            b.value = a.a.c(c());
          } };
      })();a.d.css = { update: function (b, c) {
          var d = a.a.c(c());null !== d && "object" == typeof d ? a.a.D(d, function (c, d) {
      ...
      a.d.foreach = { mc: function (b) {
        ...
        } };a.h.va.foreach = !1;a.f.aa.foreach = !0;a.d.hasfocus = { init: function (b, c, d) {
          function e(e) {
        ...
        } };a.h.ga.hasfocus = !0;a.d.hasFocus = a.d.hasfocus;a.h.ga.hasFocus = !0;a.d.html = { init: function () {
          return { controlsDescendantBindings: !0 };
        }, update: function (b, c) {
          a.a.Eb(b, c());
        } };K("if");K("ifnot", !1, !0);K("with", !0, !1, function (a, c) {
        return a.ac(c);
      });var L = {};a.d.options = { init: function (b) {
          if ("select" !== a.a.A(b)) throw Error("options binding applies only to SELECT elements");for (; 0 < b.length;) b.remove(0);return { controlsDescendantBindings: !0 };
        ...
        } };a.d.options.zb = a.a.e.J();a.d.selectedOptions = { after: ["options", "foreach"], init: function (b, c, d) {
        ...
        } };a.h.ga.selectedOptions = !0;a.d.style = { update: function (b, c) {
          var d = a.a.c(c() || {});a.a.D(d, function (c, d) {
        ...
        if (x && x.navigator) var b = function (a) {
          ...
          } };a.h.ga.textInput = !0;a.d.textinput = { preprocess: function (a, b, c) {
            c("textInput", a);
          } };
        ...
        } };a.d.uniqueName.Nc = 0;a.d.value = { after: ["options", "foreach"], init: function (b, c, d) {
          if ("input" != b.tagName.toLowerCase() || "checkbox" != b.type && "radio" != b.type) {
            var e = ["change"],
                f = d.get("valueUpdate"),
                g = !1,
                h = null;f && ("string" == typeof f && (f = [f]), a.a.ta(e, f), e = a.a.Wb(e));var l = function () {
              h = null;g = !1;var e = c(),
              ...
              var d = l;a.a.sd(c, "after") && (d = function () {
        ...
        }, update: function () {} };a.h.ga.value = !0;a.d.visible = { update: function (b, c) {
          var d = a.a.c(c()),
        ...
        function b(b, c, d, h) {
          b = a.h.Ab(b);for (var l = a.h.va, m = 0; m < b.length; m++) {
            ...
            d = /\x3c!--\s*ko\b\s*([\s\S]*?)\s*--\x3e/g;return { Tc: function (b, c, d) {
        ...
        };var h = a.a.e.J();a.d.template = { init: function (b, c) {
        ...
        function b(b, d, e, f, g) {
          var h = Math.min,
              ...
              v,
              u,
              x;for (k = 0; k <= n; k++) for (u = v, m.push(v = []), x = h(p, k + s), q = l(0, k - 1); q <= x; q++) v[q] = q ? k ? b[k - 1] === d[q - 1] ? u[q - 1] : h(u[q] || t, v[q - 1] || t) + 1 : q + 1 : k + 1;h = [];l = [];s = [];k = n;for (q = p; k || q;) p = m[k][q] - 1, q && p === m[k][q - 1] ? l.push(h[h.length] = { status: e,
            value: d[--q], index: q }) : k && p === m[k - 1][q] ? s.push(h[h.length] = { status: f, value: b[--k], index: k }) : (--q, --k, g.sparse || h.push({ status: "retained", value: d[q] }));a.a.hc(s, l, !g.dontLimitMoves && 10 * n);return h.reverse();
        ...
        function b(b, c, d, h, l) {
          ...
          function m(b, c) {
            ...
            return a.ka;
              ...
              u = 0,
              x = [],
              z = [];f = [];for (var D = [], p = [], w, C = 0, B, E; B = s[C]; C++) switch (E = B.moved, B.status) {case "deleted":
              ...
              E !== n ? m(C, E) : (w = { ka: B.value, tb: a.O(u++) }, t.push(w), z.push(w), r || (p[C] = w));}a.a.e.set(e, c, t);k(h.beforeMove, D);a.a.r(x, h.beforeRemove ? a.ba : a.removeNode);for (var C = 0, r = a.f.firstChild(e), F; w = z[C]; C++) {
            w.ea || a.a.extend(w, b(e, g, w.ka, l, w.tb));for (v = 0; s = w.ea[v]; r = s.nextSibling, F = s, v++) s !== r && a.f.kc(e, s, F);!w.ad && l && (l(w.ka, w.ea, w.tb), w.ad = !0);
...
var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    function MasterViewModel() {
        this.title = "Knockout and Webpack";
    };
...
var ContactPage = /** @class */ (function () {
    function ContactPage() {
        ...
        this.message = ko.observable(new message_1["default"](this.sampleMessage));
        this.reset = function () {
            _this.message().text(_this.sampleMessage);
        };
        this.submit = function () {
            _this.sentMessage(_this.message());
            _this.message(new message_1["default"](""));
        };
    }
    return ContactPage;
}());
...
module.exports = "<div data-bind=\"if: message() && message().text\">\n    <strong>Message sent:</strong><br />\n    <pre data-bind=\"text: message().text\"></spamn>\n</div>";
